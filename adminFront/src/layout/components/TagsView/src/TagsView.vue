          ...
          >
            <div>
              <router-link :ref="tagLinksRefs.set" :to="{ ...item }" custom v-slot="{ navigate }">
                <div
                  @click="navigate"
                  class="h-full flex items-center justify-center whitespace-nowrap"
                >
                  <div :class="`${prefixCls}__item--left`"></div>
                  <div :class="`${prefixCls}__item--text  pl-15px pr-15px`">
                    <Icon
                      v-if="
                        item?.matched &&
                        item?.matched[1] &&
                  ...
                  <div :class="`${prefixCls}__item--right`"></div>
                </div>
              </router-link>
            </div>
          </ContextMenu>
...
.#{$prefix-cls} {
  ...
  &__item {
    ...
    &--left {
      width: 6px;
      height: 31px;
      -webkit-mask-image: url('@/assets/svgs/tagBgLeft.svg');
    ...
    &--right {
      width: 6px;
      height: 31px;
      -webkit-mask-image: url('@/assets/svgs/tagBgRight.svg');
      -webkit-mask-size: 6px 14px;
