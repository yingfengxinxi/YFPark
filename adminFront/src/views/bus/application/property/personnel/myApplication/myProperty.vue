...
<template>
  <ContentWrap class="viewHeader">
    <el-menu
      ...
      @select="handleSelect"
    >
      <el-menu-item index="0">资产入库</el-menu-item>
      ...
      <el-menu-item index="7">资产处置</el-menu-item>
      <el-menu-item index="8">资产调拨</el-menu-item>
      <el-menu-item index="9">资产保养</el-menu-item>
    </el-menu>
    <Depository
      v-if="activeIndex == '0'"
...
import Depository from './component/assets/depository.vue'
import Transfer from './component/assets/transfer.vue'
import Maintain from './component/assets/maintain.vue'
import { handleTree } from '@/utils/tree'

/** 资产派发/退库 列表 */
defineOptions({ name: 'MyProperty' })
