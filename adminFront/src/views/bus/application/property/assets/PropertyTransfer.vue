  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="调出管理员" prop="outAdminUid">
        <el-select
          v-model="queryParams.outAdminUid"
          placeholder="请选择调出管理员"
          class="!w-240px"
          clearable
        >
          <el-option
      ...
      <el-form-item label="调入管理员" prop="inAdminUid">
        <el-select
          v-model="queryParams.inAdminUid"
          placeholder="请选择调入管理员"
          class="!w-240px"
          clearable
        >
          <el-option
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['bus:property-transfer:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['bus:property-transfer:export']"
        >
