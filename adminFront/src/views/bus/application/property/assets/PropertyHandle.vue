<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="处置类型" prop="handleType">
        <el-select v-model="queryParams.handleType" placeholder="" clearable class="!w-240px">
          <el-option
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['bus:property-handle:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['bus:property-handle:export']"
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      <el-table-column label="单据编号" align="center" prop="processNumber" width="230px">
      ...
      <el-table-column label="单据状态" align="center" prop="status" width="140px">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.PROPERTY_AUDIT_STATUS" :value="scope.row.status" />
        </template>
      </el-table-column>
      <el-table-column label="处置发起人" align="center" prop="cuserUid" width="170px"
        ><template #default="scope">
      ...
      <el-table-column label="发起部门" align="center" prop="departmentName" width="170px" />
      <el-table-column
        label="发起时间"
        align="center"
        prop="applyTime"
      ...
      <el-table-column
        ...
        width="140px"
      />
      <el-table-column label="处置类型" align="center" prop="handleType" width="140px">
        <template #default="scope">
      ...
      <el-table-column label="操作" align="center" width="100px" fixed="right">
        <template #default="scope">
          ...
          <el-button
            ...
            v-hasPermi="['bus:property-handle:delete']"
          >
            删除
          </el-button>
        </template>
...
import PropertyHandleForm from './PropertyHandleForm.vue'
