  ...
  <ElDrawer :title="dialogTitle" v-model="dialogVisible" size="60%">
    ...
    >
      <el-row :gutter="20">
        ...
        ></el-col>
        <el-col :span="12">
          <el-form-item label="退库后使用部门" prop="departmentId">
            <el-tree-select
        ...
        <el-col :span="12">
          <el-form-item label="退库处理人" prop="operateUid">
            <el-select
        ...
        ></el-col>
        <el-col :span="24">
          <el-form-item label="退库备注" prop="remark">
            <el-input
              placeholder="请输入"
...
/** 退库 表单 */
defineOptions({ name: 'ReturnInventoryForm' })
...
const dialogTitle = ref('资产退库') // 弹窗的标题
...
const formRules = reactive({
  ...
  departmentId: [{ required: true, message: '退库后使用部门不能为空', trigger: 'blur' }],
  operateUid: [{ required: true, message: '退库处理人不能为空', trigger: 'blur' }],
  returnTime: [{ required: true, message: '退库时间不能为空', trigger: 'blur' }]
})
