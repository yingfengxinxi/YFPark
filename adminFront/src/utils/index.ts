 ...
 * @param cellValue
 */
export const tableColumnEmptyPlaceholder = (
  _row: any,
...
export const getAssetsFile = (url) => {
  ...
  console.log(urlArr.slice(3)[0])
  // const prefix = urlArr.slice(-2)[0] // 获取倒数第二个值
  // const fileName = urlArr.slice(-1)[0] // 获取最后一个值
  // return new URL(`/src/assets/imgs/${prefix}/${fileName}`, import.meta.url).href // 使用vite推荐的方法渲染
  return new URL(`/src/assets/imgs/${url}`, import.meta.url).href // 使用vite推荐的方法渲染
}
