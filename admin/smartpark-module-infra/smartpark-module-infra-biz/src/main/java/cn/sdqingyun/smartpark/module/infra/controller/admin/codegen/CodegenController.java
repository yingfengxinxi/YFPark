package cn.sdqingyun.smartpark.module.infra.controller.admin.codegen;
...
import cn.sdqingyun.smartpark.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.sdqingyun.smartpark.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.sdqingyun.smartpark.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.sdqingyun.smartpark.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.sdqingyun.smartpark.module.infra.convert.codegen.CodegenConvert;
...
import cn.sdqingyun.smartpark.module.infra.service.codegen.CodegenService;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "smartpark"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "智慧园区")
    })
