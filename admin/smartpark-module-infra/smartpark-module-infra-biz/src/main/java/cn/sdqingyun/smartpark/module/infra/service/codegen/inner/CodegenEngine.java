package cn.sdqingyun.smartpark.module.infra.service.codegen.inner;
...
import cn.sdqingyun.smartpark.framework.apilog.core.enums.OperateTypeEnum;
import cn.sdqingyun.smartpark.framework.common.exception.util.ServiceExceptionUtil;
...
import cn.sdqingyun.smartpark.framework.common.util.date.LocalDateTimeUtils;
import cn.sdqingyun.smartpark.framework.common.util.object.BeanUtils;
import cn.sdqingyun.smartpark.framework.common.util.object.ObjectUtils;
import cn.sdqingyun.smartpark.framework.common.util.string.StrUtils;
import cn.sdqingyun.smartpark.framework.excel.core.annotations.DictFormat;
import cn.sdqingyun.smartpark.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "smartpark-module-${table.moduleName}/" + // 顶级模块
                "smartpark-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "smartpark-module-${table.moduleName}/" + // 顶级模块
                "smartpark-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "smartpark-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "smartpark-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
