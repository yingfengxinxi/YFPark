package cn.sdqingyun.smartpark.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.sdqingyun.smartpark.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "智慧园区，牛逼！")
    @ExcelProperty("结果提示")
