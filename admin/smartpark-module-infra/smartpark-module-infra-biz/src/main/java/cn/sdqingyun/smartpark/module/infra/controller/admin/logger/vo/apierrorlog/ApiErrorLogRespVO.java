package cn.sdqingyun.smartpark.module.infra.controller.admin.logger.vo.apierrorlog;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(cn.sdqingyun.smartpark.module.system.enums.DictTypeConstants.USER_TYPE)
