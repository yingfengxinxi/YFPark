package cn.sdqingyun.smartpark.module.infra.service.file;
...
import cn.sdqingyun.smartpark.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import cn.sdqingyun.smartpark.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import cn.sdqingyun.smartpark.module.infra.dal.dataobject.file.FileConfigDO;
import cn.sdqingyun.smartpark.module.infra.dal.mysql.file.FileConfigMapper;
import cn.sdqingyun.smartpark.module.infra.framework.file.core.client.FileClient;
...
import cn.sdqingyun.smartpark.module.infra.framework.file.core.client.local.LocalFileClient;
...
import static cn.sdqingyun.smartpark.framework.test.core.util.RandomUtils.randomLongId;
import static cn.sdqingyun.smartpark.framework.test.core.util.RandomUtils.randomPojo;
import static cn.sdqingyun.smartpark.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static cn.sdqingyun.smartpark.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        ...
        assertEquals("https://xxx", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/yunai").setDomain("https://xxx")));
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("智慧园区")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://xxx");

        // 调用，并断言
        assertEquals("https://xxx", fileConfigService.testFileConfig(id));
    }
