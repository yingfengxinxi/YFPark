package cn.sdqingyun.smartpark.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import cn.sdqingyun.smartpark.framework.common.pojo.PageResult;
import cn.sdqingyun.smartpark.framework.test.core.ut.BaseDbUnitTest;
import cn.sdqingyun.smartpark.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import cn.sdqingyun.smartpark.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import cn.sdqingyun.smartpark.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import cn.sdqingyun.smartpark.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import cn.sdqingyun.smartpark.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.sdqingyun.smartpark.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import cn.sdqingyun.smartpark.module.infra.dal.dataobject.codegen.CodegenTableDO;
import cn.sdqingyun.smartpark.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import cn.sdqingyun.smartpark.module.infra.dal.mysql.codegen.CodegenTableMapper;
import cn.sdqingyun.smartpark.module.infra.enums.codegen.CodegenFrontTypeEnum;
import cn.sdqingyun.smartpark.module.infra.enums.codegen.CodegenSceneEnum;
import cn.sdqingyun.smartpark.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import cn.sdqingyun.smartpark.module.infra.framework.codegen.config.CodegenProperties;
import cn.sdqingyun.smartpark.module.infra.service.codegen.inner.CodegenBuilder;
import cn.sdqingyun.smartpark.module.infra.service.codegen.inner.CodegenEngine;
import cn.sdqingyun.smartpark.module.infra.service.db.DatabaseTableService;
...
import static cn.sdqingyun.smartpark.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.sdqingyun.smartpark.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.sdqingyun.smartpark.framework.common.util.object.ObjectUtils.cloneIgnoreId;
...
import static cn.sdqingyun.smartpark.module.infra.enums.ErrorCodeConstants.*;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        when(tableInfo.getComment()).thenReturn("智慧园区");
    ...
    @Test
    @Disabled // 需要替换 @智慧园区：这个单测会随机性失败，需要定位下；
    ...
    public void testGetDatabaseTableList() {
        ...
        when(tableInfo01.getComment()).thenReturn("智慧园区");
        TableInfo tableInfo02 = mock(TableInfo.class);
        when(tableInfo02.getName()).thenReturn("t_yunai_02");
        when(tableInfo02.getComment()).thenReturn("智慧园区_02");
        ...
        assertEquals("智慧园区", result.get(0).getComment());
    }
