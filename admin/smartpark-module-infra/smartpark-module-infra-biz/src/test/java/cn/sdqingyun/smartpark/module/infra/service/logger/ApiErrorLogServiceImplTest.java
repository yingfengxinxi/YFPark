package cn.sdqingyun.smartpark.module.infra.service.logger;
...
import cn.sdqingyun.smartpark.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.sdqingyun.smartpark.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.sdqingyun.smartpark.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.sdqingyun.smartpark.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.sdqingyun.smartpark.framework.common.util.date.LocalDateTimeUtils.*;
...
import static cn.sdqingyun.smartpark.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.sdqingyun.smartpark.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("smartpark-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("smartpark-test");
