package cn.sdqingyun.smartpark.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setBucket("smartparkyuanma");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.smartpark.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.smartpark.iocoder.cn
        // 默认上海的 endpoint
