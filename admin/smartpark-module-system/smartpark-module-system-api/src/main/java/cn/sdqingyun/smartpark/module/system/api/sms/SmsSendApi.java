...
public interface SmsSendApi {
    ...
    @Operation(summary = "发送单条短信给 Owner 用户", description = "调用阿里云api工具类发送短信")
    CommonResult<Long> sendSingleSmsToOwner(@Valid @RequestBody SmsSendSingleToUserReqDTO reqDTO) throws Exception;
