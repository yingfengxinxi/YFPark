package cn.sdqingyun.smartpark.module.system.api.social.dto;
...
public class SocialUserRespDTO {
    ...
    @Schema(description = "社交用户的昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "智慧园区")
    private String nickname;

    @Schema(description = "社交用户的头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://xxx/1.jpg")
