...
public interface MailSendApi {
    ...
    @Operation(summary = "发送单条邮件给 owner 用户", description = "在 mail 为空时，使用 userId 加载对应 Member 的邮箱")
    CommonResult<Long> sendSingleMailToOwner(@Valid @RequestBody MailSendSingleToUserReqDTO reqDTO);
