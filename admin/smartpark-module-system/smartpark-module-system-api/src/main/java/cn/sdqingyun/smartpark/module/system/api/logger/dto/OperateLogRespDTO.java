package cn.sdqingyun.smartpark.module.system.api.logger.dto;
...
public class OperateLogRespDTO implements VO {
    ...
    @Trans(type = TransType.RPC, targetClassName = "cn.sdqingyun.smartpark.module.system.dal.dataobject.user.AdminUserDO",
            fields = "nickname", ref = "userName")
    private Long userId;
    @Schema(description = "用户名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "智慧园区")
    ...
    @Schema(description = "操作内容", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从智慧园区改成源码")
