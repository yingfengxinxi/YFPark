...
import cn.sdqingyun.smartpark.framework.datapermission.core.util.DataPermissionUtils;
...
import static cn.sdqingyun.smartpark.module.system.enums.LogRecordConstants.*;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:smartparkyuanma}")
     ...
     * @return
     */
    public List<AdminUserDO> getTenantIdUserInfoList() {

        LambdaQueryWrapperX<AdminUserDO> queryWrapperX = new LambdaQueryWrapperX<>();
        LoginUser loginUser = SecurityFrameworkUtils.getLoginUser();
        queryWrapperX.eq(AdminUserDO::getTenantId, loginUser.getTenantId());
        queryWrapperX.eq(AdminUserDO::getStatus,"0");
        return userMapper.selectList(queryWrapperX);
    }
}
