...
import static cn.sdqingyun.smartpark.framework.common.util.cache.CacheUtils.buildAsyncReloadingCache;
...
public class SmsChannelServiceImpl implements SmsChannelService {
    ...
    public Long createSmsChannel(SmsChannelSaveReqVO createReqVO) {
        ...
        channel.setTenantId(TenantContextHolder.getTenantId());
