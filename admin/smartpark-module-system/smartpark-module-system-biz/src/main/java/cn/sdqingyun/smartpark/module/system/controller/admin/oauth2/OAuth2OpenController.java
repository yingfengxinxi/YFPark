...
import cn.sdqingyun.smartpark.framework.common.util.http.HttpUtils;
...
import cn.sdqingyun.smartpark.module.system.convert.oauth2.OAuth2OpenConvert;
...
import cn.sdqingyun.smartpark.module.system.util.oauth2.OAuth2Utils;
...
import static cn.sdqingyun.smartpark.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.sdqingyun.smartpark.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://xxx"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://xxx"),
