...
import cn.sdqingyun.smartpark.module.system.controller.admin.notify.vo.template.NotifyTemplatePageReqVO;
import cn.sdqingyun.smartpark.module.system.controller.admin.notify.vo.template.NotifyTemplateSaveReqVO;
import cn.sdqingyun.smartpark.module.system.dal.dataobject.notify.NotifyTemplateDO;
import cn.sdqingyun.smartpark.module.system.dal.mysql.notify.NotifyTemplateMapper;
...
import static cn.sdqingyun.smartpark.module.system.enums.ErrorCodeConstants.NOTIFY_TEMPLATE_CODE_DUPLICATE;
import static cn.sdqingyun.smartpark.module.system.enums.ErrorCodeConstants.NOTIFY_TEMPLATE_NOT_EXISTS;
...
public class NotifyTemplateServiceImpl implements NotifyTemplateService {
    ...
    public Long createNotifyTemplate(NotifyTemplateSaveReqVO createReqVO) {
        ...
        notifyTemplate.setTenantId(TenantContextHolder.getRequiredTenantId());
    ...
    public void updateNotifyTemplate(NotifyTemplateSaveReqVO updateReqVO) {
        ...
        updateObj.setTenantId(TenantContextHolder.getRequiredTenantId());
