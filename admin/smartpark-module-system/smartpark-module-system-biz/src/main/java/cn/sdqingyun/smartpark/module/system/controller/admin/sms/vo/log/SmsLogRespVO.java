package cn.sdqingyun.smartpark.module.system.controller.admin.sms.vo.log;
...
import cn.sdqingyun.smartpark.framework.excel.core.convert.JsonConvert;
...
public class SmsLogRespVO {
    ...
    @Schema(description = "手机号", requiredMode = Schema.RequiredMode.REQUIRED, example = "131111111111")
    @ExcelProperty("手机号")
