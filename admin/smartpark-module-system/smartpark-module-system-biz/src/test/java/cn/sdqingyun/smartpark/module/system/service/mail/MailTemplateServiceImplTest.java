package cn.sdqingyun.smartpark.module.system.service.mail;
...
import cn.sdqingyun.smartpark.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import cn.sdqingyun.smartpark.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import cn.sdqingyun.smartpark.module.system.dal.dataobject.mail.MailTemplateDO;
import cn.sdqingyun.smartpark.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.sdqingyun.smartpark.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("智慧园区")));
        // 测试 code 不匹配
