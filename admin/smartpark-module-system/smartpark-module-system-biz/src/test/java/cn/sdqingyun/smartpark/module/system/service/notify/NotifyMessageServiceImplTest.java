...
public class NotifyMessageServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetUnreadNotifyMessageList() {
        ...
        // 调用
        NotifyMessagePageReqVO notifyMessagePageReqVO = new NotifyMessagePageReqVO();
        notifyMessagePageReqVO.setUserId(userId);
        notifyMessagePageReqVO.setUserType(userType);
        notifyMessagePageReqVO.setPageSize(size);
        List<NotifyMessageDO> list = notifyMessageService.getUnreadNotifyMessageList(notifyMessagePageReqVO);
        // 断言
