...
import cn.sdqingyun.smartpark.framework.mybatis.core.enums.SqlConstants;
...
import cn.sdqingyun.smartpark.module.system.dal.dataobject.sms.SmsCodeDO;
import cn.sdqingyun.smartpark.module.system.dal.mysql.sms.SmsCodeMapper;
import cn.sdqingyun.smartpark.module.system.enums.sms.SmsSceneEnum;
import cn.sdqingyun.smartpark.module.system.framework.sms.config.SmsCodeProperties;
...
public class SmsCodeServiceImplTest extends BaseDbUnitTest {
    ...
    public void sendSmsCode_tooFast() {
        ...
        SmsCodeDO smsCodeDO = randomPojo(SmsCodeDO.class,
                o -> o.setMobile("131111111111").setTodayIndex(1));
    ...
    public void sendSmsCode_exceedDay() {
        // mock 数据
        SmsCodeDO smsCodeDO = randomPojo(SmsCodeDO.class,
                o -> o.setMobile("131111111111").setTodayIndex(10).setCreateTime(LocalDateTime.now()));
        smsCodeMapper.insert(smsCodeDO);
        // 准备参数
        SmsCodeSendReqDTO reqDTO = randomPojo(SmsCodeSendReqDTO.class, o -> {
            o.setMobile("131111111111");
