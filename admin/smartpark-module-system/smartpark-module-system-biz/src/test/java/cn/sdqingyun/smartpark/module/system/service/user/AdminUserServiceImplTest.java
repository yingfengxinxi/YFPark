package cn.sdqingyun.smartpark.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.sdqingyun.smartpark.framework.common.enums.CommonStatusEnum;
import cn.sdqingyun.smartpark.framework.common.exception.ServiceException;
import cn.sdqingyun.smartpark.framework.common.pojo.PageResult;
import cn.sdqingyun.smartpark.framework.common.util.collection.ArrayUtils;
...
import cn.sdqingyun.smartpark.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.sdqingyun.smartpark.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.sdqingyun.smartpark.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.sdqingyun.smartpark.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.sdqingyun.smartpark.module.system.controller.admin.user.vo.user.UserPageReqVO;
...
import cn.sdqingyun.smartpark.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.sdqingyun.smartpark.module.system.dal.mysql.dept.UserPostMapper;
import cn.sdqingyun.smartpark.module.system.dal.mysql.user.AdminUserMapper;
import cn.sdqingyun.smartpark.module.system.enums.common.SexEnum;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("smartparkyuanma");
        ...
        assertEquals("smartparkyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("smartparkyuanma"))).thenReturn("java");
