package cn.sdqingyun.smartpark.module.system.controller.admin.oauth2;
...
import cn.sdqingyun.smartpark.framework.common.util.collection.SetUtils;
import cn.sdqingyun.smartpark.framework.common.util.object.ObjectUtils;
import cn.sdqingyun.smartpark.framework.test.core.ut.BaseMockitoUnitTest;
import cn.sdqingyun.smartpark.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import cn.sdqingyun.smartpark.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import cn.sdqingyun.smartpark.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import cn.sdqingyun.smartpark.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import cn.sdqingyun.smartpark.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import cn.sdqingyun.smartpark.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import cn.sdqingyun.smartpark.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import cn.sdqingyun.smartpark.module.system.service.oauth2.OAuth2ApproveService;
import cn.sdqingyun.smartpark.module.system.service.oauth2.OAuth2ClientService;
import cn.sdqingyun.smartpark.module.system.service.oauth2.OAuth2GrantService;
import cn.sdqingyun.smartpark.module.system.service.oauth2.OAuth2TokenService;
...
import static cn.sdqingyun.smartpark.framework.common.util.collection.SetUtils.asSet;
...
import static cn.sdqingyun.smartpark.framework.test.core.util.RandomUtils.randomPojo;
import static cn.sdqingyun.smartpark.framework.test.core.util.RandomUtils.randomString;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://xxx#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        assertThat(result.getData(), anyOf( // 29 和 30 都有一定概率，主要是时间计算
                is("https://xxx#access_token=test_access_token&token_type=bearer&state=test&expires_in=29&scope=read"),
                is("https://xxx#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read")
        ));
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://xxx?code=test_code&state=test", result.getData());
    }
