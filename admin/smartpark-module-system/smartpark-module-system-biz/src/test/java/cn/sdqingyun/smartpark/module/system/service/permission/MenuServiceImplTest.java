...
import cn.sdqingyun.smartpark.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import cn.sdqingyun.smartpark.module.system.dal.dataobject.permission.MenuDO;
import cn.sdqingyun.smartpark.module.system.dal.mysql.permission.MenuMapper;
import cn.sdqingyun.smartpark.module.system.enums.permission.MenuTypeEnum;
...
import static cn.sdqingyun.smartpark.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("智慧园区").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
