package cn.sdqingyun.smartpark.module.system.service.tenant;

import cn.sdqingyun.smartpark.framework.common.enums.CommonStatusEnum;
import cn.sdqingyun.smartpark.framework.common.pojo.PageResult;
import cn.sdqingyun.smartpark.framework.tenant.config.TenantProperties;
...
import cn.sdqingyun.smartpark.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.sdqingyun.smartpark.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.sdqingyun.smartpark.module.system.dal.dataobject.permission.MenuDO;
import cn.sdqingyun.smartpark.module.system.dal.dataobject.permission.RoleDO;
import cn.sdqingyun.smartpark.module.system.dal.dataobject.tenant.TenantDO;
import cn.sdqingyun.smartpark.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.sdqingyun.smartpark.module.system.dal.mysql.tenant.TenantMapper;
import cn.sdqingyun.smartpark.module.system.enums.permission.RoleCodeEnum;
import cn.sdqingyun.smartpark.module.system.enums.permission.RoleTypeEnum;
import cn.sdqingyun.smartpark.module.system.service.permission.MenuService;
...
import cn.sdqingyun.smartpark.module.system.service.tenant.handler.TenantInfoHandler;
import cn.sdqingyun.smartpark.module.system.service.tenant.handler.TenantMenuHandler;
...
import static cn.sdqingyun.smartpark.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static cn.sdqingyun.smartpark.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("智慧园区", user.getNickname());
            assertEquals("131111111111", user.getMobile());
            return true;
        }))).thenReturn(300L);

        // 准备参数
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            o.setContactName("智慧园区");
            o.setContactMobile("131111111111");
            o.setPackageId(100L);
            o.setStatus(randomCommonStatus());
            o.setWebsite("https://xxx");
            o.setUsername("yunai");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("智慧园区"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("智慧园区");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
    ...
    public void testGetTenantByWebsite() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsite("https://xxx"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://xxx");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
