...
import cn.sdqingyun.smartpark.module.bus.controller.admin.village.vo.villagebuild.BuildArr;
import cn.sdqingyun.smartpark.module.bus.controller.admin.village.vo.villagebuild.BuildList;
import cn.sdqingyun.smartpark.module.bus.controller.admin.village.vo.villagebuild.RoomStatusColor;
...
@Data
public class VillageInsertReqVO {
    @Schema(description = "编号", example = "3871")
    private Long id;

    @Schema(description = "项目名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "中国北京中南海")
    @NotNull(message = "项目名称不能为空")
    private String name;

    @Schema(description = "项目名称缩写",requiredMode = Schema.RequiredMode.REQUIRED, example = "中南海")
