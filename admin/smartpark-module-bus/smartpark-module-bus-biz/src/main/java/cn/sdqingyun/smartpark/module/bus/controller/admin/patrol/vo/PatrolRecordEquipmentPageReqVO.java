...
@Schema(description = "管理后台 - 应用巡检记录分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class PatrolRecordEquipmentPageReqVO extends PageParam {
    ...
    @Schema(description = "签到状态", example = "2")
    ...
    @Schema(description = "巡检状态;1=待开始2=正常3=异常未整改4=异常已整改5=跳过【字典值PATROL_RECORD_EQUIPMENT_STATUS】", example = "2")
    private String status;

    @Schema(description = "整改处理状态;1=待处理;2=处理中;3=已处理", example = "2")
