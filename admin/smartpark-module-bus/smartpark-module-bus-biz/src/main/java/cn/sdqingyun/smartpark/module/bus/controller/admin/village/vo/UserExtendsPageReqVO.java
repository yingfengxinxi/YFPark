...
@Schema(description = "管理后台 - 用户信息扩展分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class UserExtendsPageReqVO extends PageParam {
    ...
    @Schema(description = "单位性质", example = "1")
    ...
    @Schema(description = "房间唯一编号id", example = "12594")
