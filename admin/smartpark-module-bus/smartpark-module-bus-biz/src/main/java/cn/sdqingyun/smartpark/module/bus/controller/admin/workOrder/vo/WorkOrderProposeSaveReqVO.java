...
@Schema(description = "管理后台 - 机构工单数据新增/修改 Request VO")
@Data
public class WorkOrderProposeSaveReqVO  extends TenantBaseDO {
    ...
    @Schema(description = "报修类型;1=室内报修;2=公共区域报修;", requiredMode = Schema.RequiredMode.REQUIRED, example = "2")
    @NotEmpty(message = "报修类型;1=室内报修;2=公共区域报修;不能为空")
    ...
    @NotEmpty(message = "费用支付方;1=租客承担;2=机构承担;不能为空")
    ...
    @Schema(description = "房间id集合", example = "30763")
    ...
    @Schema(description = "是否超时;0=否;1=是;", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "工单状态;1=未指派,2=已指派,3=处理中,4=已办结", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
