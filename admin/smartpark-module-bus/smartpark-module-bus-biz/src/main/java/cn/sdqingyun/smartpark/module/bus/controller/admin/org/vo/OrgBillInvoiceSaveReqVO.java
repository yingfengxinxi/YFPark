...
@Schema(description = "管理后台 - 机构账单开票记录新增/修改 Request VO")
@Data
public class OrgBillInvoiceSaveReqVO  extends TenantBaseDO {
    ...
    @NotEmpty(message = "发票状态;1=待开票;2=已开票;3=已冲红;4=已作废;5=已开负数发票;6=作废审批中;不能为空")
    ...
    @NotEmpty(message = "是否需要开据电子发票 1需要 0不需要不能为空")
    ...
    @NotEmpty(message = "电子发票开据状态 0未开票 1开票成功 2开票中 3开票失败不能为空")
    ...
    @NotEmpty(message = "冲红电子发票开据状态 0未开票 1开票成功 2开票中 3开票失败不能为空")
