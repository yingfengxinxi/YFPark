...
@Schema(description = "管理后台 - 房源标签 Response VO")
@Data
@ExcelIgnoreUnannotated
public class TagHouseRespVO {

    @Schema(description = "编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "27610")
    @ExcelProperty("编号")
    private Long id;
