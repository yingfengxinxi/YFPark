...
@Schema(description = "管理后台 - 机构账单收支流水新增/修改 Request VO")
@Data
public class BillStreamSaveReqVO extends TenantBaseDO {

    @Schema(description = "编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "19311")
    private Long id;
    ...
    @Schema(description = "流水来源;1=手动创建;", requiredMode = Schema.RequiredMode.REQUIRED)
    private String streamSource;

    @Schema(description = "账单类型;1=收款;2=付款;", example = "1")
    private String billType;

    @Schema(description = "流水是否开启;0=关闭;1=开启;默认开启", requiredMode = Schema.RequiredMode.REQUIRED)
    private String isClose;

    @Schema(description = "借贷类型", example = "1")
    private String loanType;

    @Schema(description = "是否确认;1=待确认;2=已确认;", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "退款金额", requiredMode = Schema.RequiredMode.REQUIRED, example = "10024")
    ...
    @Schema(description = "删除流水申请的状态0正常1删除中2已删除", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    private String approvalStatus;

    @Schema(description = "删除审批中是否允许撤销0不允许1允许", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "流水来源0=收款中创建数据1=流水中新建2=回调新建", example = "2")
