...
@Schema(description = "管理后台 - 机构合同账单明细 Response VO")
@Data
@ExcelIgnoreUnannotated
public class ContractOrderBillRespVO {
    ...
    @ExcelProperty("状态0=未支付1=已支付2=逾期")
