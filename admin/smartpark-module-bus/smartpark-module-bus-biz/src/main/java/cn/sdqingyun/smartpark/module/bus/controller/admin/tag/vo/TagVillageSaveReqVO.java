...
@Schema(description = "管理后台 - 项目标签新增/修改 Request VO")
@Data
public class TagVillageSaveReqVO  extends TenantBaseDO {

    @Schema(description = "编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "2322")
    private Long id;

    @Schema(description = "机构ID", example = "15859")
