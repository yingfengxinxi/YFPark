...
public class UserSystemFieldExtendPageReqVO extends PageParam {

    @Schema(description = "字段名称", example = "赵六")
    ...
    @Schema(description = "输入框类型", example = "2")
    ...
    @Schema(description = "是否允许修改表单名称，1允许修改，0不允许")
