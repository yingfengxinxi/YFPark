package cn.sdqingyun.smartpark.gateway.util;

import cn.hutool.core.map.MapUtil;
import cn.sdqingyun.smartpark.framework.common.util.json.JsonUtils;
import cn.sdqingyun.smartpark.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from smartpark-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * @author 智慧园区
 */
@Slf4j
