package cn.sdqingyun.smartpark.gateway.filter.logging;

import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.json.JSONUtil;
import cn.sdqingyun.smartpark.framework.common.util.json.JsonUtils;
import cn.sdqingyun.smartpark.gateway.util.SecurityFrameworkUtils;
import cn.sdqingyun.smartpark.gateway.util.WebFrameworkUtils;
 ...
 * 网关的访问日志过滤器
 *
 * 从功能上，它类似 smartpark-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 *
 * 需要替换 智慧园区：如果网关执行异常，不会记录访问日志，后续研究下 https://github.com/Silvmike/webflux-demo/blob/master/tests/src/test/java/ru/hardcoders/demo/webflux/web_handler/filters/logging
 *
 * @author 智慧园区
 */
@Slf4j
        ...
        return new ServerHttpRequestDecorator(exchange.getRequest()) {
            ...
            public HttpHeaders getHeaders() {
                ...
                if (contentLength > 0) {
                    ...
                    // 需要替换: this causes a 'HTTP/1.1 411 Length Required' // on
                    // httpbin.org
