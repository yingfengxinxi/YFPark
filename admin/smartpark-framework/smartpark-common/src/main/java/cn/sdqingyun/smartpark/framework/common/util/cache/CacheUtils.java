package cn.sdqingyun.smartpark.framework.common.util.cache;
...
public class CacheUtils {
    ...
    public static <K, V> LoadingCache<K, V> buildAsyncReloadingCache(Duration duration, CacheLoader<K, V> loader) {
        return CacheBuilder.newBuilder()
                ...
                .build(CacheLoader.asyncReloading(loader, Executors.newCachedThreadPool())); // 需要替换 智慧园区：可能要思考下，未来要不要做成可配置
    }
