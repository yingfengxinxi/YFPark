package cn.sdqingyun.smartpark.framework.dict.core;
...
public class DictFrameworkUtils {
    ...
    // 需要替换 @puhui999：GET_DICT_DATA_CACHE、GET_DICT_DATA_LIST_CACHE、PARSE_DICT_DATA_CACHE 这 3 个缓存是有点重叠，可以思考下，有没可能减少 1 个。微信讨论好私聊，再具体改哈
    /**
    ...
    /**
     * 针对 {@link #getDictDataValueList(String)} 的缓存
     */
    private static final LoadingCache<String, List<String>> GET_DICT_DATA_LIST_VALUE = CacheUtils.buildAsyncReloadingCache(
            Duration.ofMinutes(1L), // 过期时间 1 分钟
            new CacheLoader<String, List<String>>() {

                @Override
                public List<String> load(String dictType) {
                    return dictDataApi.getDictDataValueList(dictType);
                }
    ...
    public static List<String> getDictDataValueList(String dictType) {
        return GET_DICT_DATA_LIST_VALUE.get(dictType);
    }
