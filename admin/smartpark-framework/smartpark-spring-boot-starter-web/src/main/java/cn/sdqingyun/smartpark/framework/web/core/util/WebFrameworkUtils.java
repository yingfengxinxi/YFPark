package cn.sdqingyun.smartpark.framework.web.core.util;

import cn.hutool.core.util.NumberUtil;
import cn.sdqingyun.smartpark.framework.common.enums.RpcConstants;
import cn.sdqingyun.smartpark.framework.common.enums.TerminalEnum;
...
public class WebFrameworkUtils {
    ...
    private static final String HEADER_DEPT_ID_LIST = "deptIdList";

    /**
     * 终端的 Header
     *
     * @see cn.sdqingyun.smartpark.framework.common.enums.TerminalEnum
     */
    ...
    public static String getDeptIdList() {
        HttpServletRequest request = getRequest();
        return getDeptIdList(request);
    }

    public static String getDeptIdList(HttpServletRequest request) {
        return request.getHeader(HEADER_DEPT_ID_LIST);
    }
}
