 ...
 *      1）Spring Async：
 *          {@link cn.sdqingyun.smartpark.framework.quartz.config.SmartparkAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 SmartparkSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.sdqingyun.smartpark.framework.tenant;
