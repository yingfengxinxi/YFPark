package cn.sdqingyun.smartpark.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${smartpark.websocket.sender-rocketmq.topic}",
        consumerGroup = "${smartpark.websocket.sender-rocketmq.consumer-group}",
